...
format: 
  revealjs:
    ...
    chalkboard: true
    slide-number: true
    footer: "Econ 115a: Eeconometrics lab"
engine: knitr
from: markdown+emoji
editor: visual
---
...
## working directory
# setwd("C:/Users/chris/Documents/Github-repository/econ115a-laboratory/module-02-intro-ggplot")
...
knitr::include_graphics("img/econ115a-hex-logo.png")
```
