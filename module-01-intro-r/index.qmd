...
format: 
  revealjs:
    ...
    chalkboard: true
    slide-number: true
    footer: "Econ 115a: Econometrics lab"
engine: knitr
from: markdown+emoji
editor: visual
---
...
## working directory
# setwd("C:/Users/chris/Documents/Github-repository/econ115a-laboratory/module-01-intro-r")
...
![](img/econ115a-hex-logo.png){fig-align="center" height="40%" width="40%"}
